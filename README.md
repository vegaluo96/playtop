...
- **<1080px 移动**:4 Tab + 二级页 + 底部 sheet(下表)
- **≥1080px 桌面**:三栏终端(左赛事列表 / 中 7 tab 工作区含 AI 报告 / 右异动流+本场预测),
  1080–1239 区间左右栏压至最小宽(左≥260 / 右≥280),≥1240 舒适三栏;
...
| `/match/[id]` | 详情 4 组:盘口(走势/百家对比/盘路/更多玩法)/赛况(直播时间轴+天气)/人员(阵容+情报)/深度(深挖+AI报告) |
