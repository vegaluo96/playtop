...
import { fetchResultsFromCsv, fetchResultsFromEspn, fetchResultsViaAi } from "./fetchResults";
...
export async function tickResults(): Promise<{ csv: number; espn: number; ai: number }> {
