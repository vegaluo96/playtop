...
/** 常见问题(我的页入口):报告额度/解锁/数据口径/刷新频率/综合指数 */
...
const FAQ: { q: string; a: string }[] = [
  {
    q: "报告额度是什么?可以提现吗?",
    a: "报告额度只用于解锁 AI 概率报告,1 元 = 10 额度起,购买档位越高加赠越多。报告额度不具备货币属性,不可提现、不可转让。",
  },
  {
    q: "哪些内容收费?哪些免费?",
    a: "全站唯一收费项是「AI 概率报告」:赛前 38 额度/场,开赛后 58 额度/场,解锁后可回看。指数走势、对比、异动流、技术统计、阵容情报等基础行情开放;登录后查看完整数据。",
  },
  {
    q: "数据多久刷新一次?",
    a: "按「距开赛时间」分 8 档自动加密:赛前 14 天起接入(每 12 小时),临近开赛逐级加快,滚球期按数据源允许的最高频率更新(最快 5 秒)。任意页面点「数据刷新规则」可查看当前实际生效的档位表。",
  },
  {
    q: "综合指数是什么?",
    a: "综合指数是本站对多家数据源的聚合计价:取各家主指数线的中位数为「共识指数线」,再取该指数线下各家净水的中位数作为指数值;滚球段为实时盘直读。它是本站计算值,不代表任何单一公司报价,计算方法在每张图下方完整公开。",
  },
  {
    q: "为什么有的比赛没有概率方向?",
    a: "概率方向来自数据模型。当模型方向缺失时,平台只会把当前指数低水侧作为「指数派生观点」降权展示;两者都不可用时如实显示暂无,绝不编造。",
  },
  {
    q: "AI 报告会更新吗?",
    a: "会。赛前指数或阵容发生实质变化时自动生成新版本(可在报告页切换历史版本、查看每版变化);开赛后报告锁定为临场版,不再变动。",
  },
  {
    q: "指数走势图为什么开赛前点比较稀疏?",
  ...
  {
    q: "遇到问题怎么反馈?",
    a: "「我 · 系统工单」提交问题,客服回复后我的页会出现红点提醒。购买额度类问题请附购买时间与档位。",
  },
];
