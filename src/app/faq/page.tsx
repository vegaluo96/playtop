...
const FAQ: { q: string; a: string }[] = [
  {
    q: "积分是什么?可以提现吗?",
    a: "积分是平台内解锁深度数据(官方预测与 AI 报告)的唯一凭证,1 元 = 10 积分起,充值档位越高加赠越多。积分不具备货币属性,不可提现、不可转让。",
  },
  {
    q: "哪些内容收费?哪些免费?",
    a: "全站唯一收费项是「赛事预测(含 AI 分析报告)」:赛前 38 积分/场,开赛后 58 积分/场,解锁后永久可见。盘口走势、百家对比、异动流、技术统计、阵容情报等全部免费(注册后完整可见)。每天另有平台指定的免费预测场次。",
  },
  {
    q: "数据多久刷新一次?",
  ...
  {
    q: "为什么有的比赛没有预测方向?",
    a: "预测来自官方数据模型。当模型样本不足时,平台会改用当前盘口推导方向并明确标注「盘口推导」;两者都不可用时如实显示暂无,绝不编造。",
  },
  {
    q: "AI 报告会更新吗?",
