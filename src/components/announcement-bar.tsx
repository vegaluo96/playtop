  ...
  return (
    <div
      style={{
        ...
        background: "rgba(233,185,73,.08)", borderBottom: "1px solid rgba(233,185,73,.25)",
      }}
    >
      <span style={{ fontSize: 9, fontWeight: 800, color: "var(--gold)", border: "1px solid rgba(233,185,73,.45)", borderRadius: 4, padding: "1px 6px", flexShrink: 0 }}>公告</span>
